                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
                            <div class="text-center">
                                <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-2">RUNDOWN ACARA
                                    OLAHRAGA</h1>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 mb-4 sm:mb-6">
                            <div class="flex flex-col sm:flex-row justify-center gap-2 sm:gap-2">
                                <button v-for="day in days" :key="day.id" @click="selectedDay = day.id" :class="[
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            <div v-if="selectedDay === 1" class="p-3 sm:p-4 md:p-6">
                                <div class="flex flex-col sm:flex-row sm:items-center mb-4 sm:mb-6">
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-[#D71E28] rounded-full flex items-center justify-center mb-3 sm:mb-0 sm:mr-4 mx-auto sm:mx-0">
                                        <i class="fas fa-calendar-day text-white text-lg sm:text-xl"></i>
                                    </div>
                                    <div class="text-center sm:text-left">
                                        <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">DAY 1 -
                                            Opening Ceremony</h2>
                                ...
                                <div class="hidden sm:block overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr v-for="(event, index) in day1Events" :key="index"
                                                class="hover:bg-gray-50">
                                                <td class="px-3 md:px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <i class="fas fa-clock text-[#D71E28] mr-2"></i>
                                                        <span class="text-sm font-medium text-gray-900">{{ event.time
                                                            }}</span>
                                                    </div>
                                                </td>
                                                <td class="px-3 md:px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td class="px-3 md:px-6 py-4">
                                                    <div class="text-sm font-medium text-gray-900">{{ event.activity }}
                                                    </div>
                                                </td>
                                                <td class="px-3 md:px-6 py-4">
                            ...
                            <div v-if="selectedDay === 2" class="p-3 sm:p-4 md:p-6">
                                <div class="flex flex-col sm:flex-row sm:items-center mb-4 sm:mb-6">
                                    ...
                                    <div class="text-center sm:text-left">
                                        <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">DAY 2 -
                                            Pertandingan Penyisihan</h2>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                                    ...
                                    <div
                                        class="bg-gradient-to-r from-green-50 to-green-100 p-4 sm:p-6 rounded-lg border border-green-200">
                                        <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-4">
                                            <i
                                                class="fas fa-running text-green-600 text-xl sm:text-2xl mb-2 sm:mb-0 sm:mr-3 text-center"></i>
                                            <div class="text-center sm:text-left">
                                                <h3 class="text-base sm:text-lg font-semibold text-green-800">5K Fun Run
                                                </h3>
                                                <p class="text-xs sm:text-sm text-green-600">05:30 - 06:30</p>
                                            </div>
                                        </div>
                                        <p class="text-sm sm:text-base text-green-700 text-center sm:text-left">
                                            Jakabaring Sport Center & Sarapan Pagi</p>
                                    </div>
                                    <div
                                        class="bg-gradient-to-r from-blue-50 to-blue-100 p-4 sm:p-6 rounded-lg border border-blue-200">
                                        <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-4">
                                            <i
                                                class="fas fa-medal text-blue-600 text-xl sm:text-2xl mb-2 sm:mb-0 sm:mr-3 text-center"></i>
                                            <div class="text-center sm:text-left">
                                                <h3 class="text-base sm:text-lg font-semibold text-blue-800">
                                                    Pertandingan Penyisihan</h3>
                                                <p class="text-xs sm:text-sm text-blue-600">07:00 - 18:00</p>
                                            </div>
                                        </div>
                                        <p class="text-sm sm:text-base text-blue-700 text-center sm:text-left">Semua
                                            cabang olahraga di berbagai venue</p>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 p-4 sm:p-6 rounded-lg">
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4 text-center sm:text-left">
                                        <i class="fas fa-map-marker-alt text-[#D71E28] mr-2"></i>
                                        Venue Pertandingan
                                    </h3>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                                        <div v-for="venue in venues" :key="venue.sport"
                                            class="bg-white p-3 sm:p-4 rounded-lg shadow-sm border">
                                            <div class="flex flex-col sm:flex-row sm:items-center mb-2">
                                                <i :class="venue.icon"
                                                    class="text-[#D71E28] mr-0 sm:mr-2 mb-1 sm:mb-0 text-center"></i>
                                                <span
                                                    class="font-medium text-gray-800 text-sm sm:text-base text-center sm:text-left">{{
                                                        venue.sport }}</span>
                                            </div>
                            ...
                            <div v-if="selectedDay === 3" class="p-3 sm:p-4 md:p-6">
                                <div class="flex flex-col sm:flex-row sm:items-center mb-4 sm:mb-6">
                                    ...
                                    <div class="text-center sm:text-left">
                                        <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">DAY 3 - Final
                                            & Closing Ceremony</h2>
                                ...
                                <div class="hidden sm:block overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr v-for="(event, index) in day3Events" :key="index"
                                                class="hover:bg-gray-50">
                                                <td class="px-3 md:px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <i class="fas fa-clock text-[#D71E28] mr-2"></i>
                                ...
                                <div
                                    class="mt-4 sm:mt-6 bg-gradient-to-r from-red-50 to-pink-50 p-4 sm:p-6 rounded-lg border border-red-200">
                                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-4">
                                        <i
                                            class="fas fa-fire text-red-600 text-xl sm:text-2xl mb-2 sm:mb-0 sm:mr-3 text-center"></i>
                                        <h3
                                            class="text-base sm:text-lg font-semibold text-red-800 text-center sm:text-left">
                                            Penutupan Acara</h3>
                                    </div>
                                    <p class="text-sm sm:text-base text-red-700 text-center sm:text-left">Pemadaman Api
                                        Obor disertai Flashmob Artis Ibukota - Penutupan resmi acara olahraga</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 sm:p-6 mt-4 sm:mt-6">
                            <div class="flex flex-col sm:flex-row sm:items-start">
                                <i
                                    class="fas fa-exclamation-triangle text-yellow-600 text-lg sm:text-xl mb-2 sm:mb-0 sm:mr-3 sm:mt-1 text-center"></i>
                                <div>
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-yellow-800 mb-2 text-center sm:text-left">
                                        Catatan Penting:</h3>
