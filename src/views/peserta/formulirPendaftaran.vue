                ...
                <section class="min-h-screen p-6 bg-gray-100">
                    <div class="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-8">
                        ...
                        <div v-if="loading" class="text-center py-8">
                            <div class="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-[#D71E28]">
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" v-model="form.email" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent"
                                            placeholder="email@example.com (gunakan email saat anda daftar)">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select v-model="form.jenis_kelamin" @change="resetConditionalFields" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                            ...
                            <div v-if="form.jenis_peserta" class="bg-gray-50 p-6 rounded-lg">
                                ...
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('ktp', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.ktp" class="text-red-500 text-sm mt-1">{{ fileErrors.ktp }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('id_card', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.id_card" class="text-red-500 text-sm mt-1">{{
                                            fileErrors.id_card }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('bpjs', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.bpjs" class="text-red-500 text-sm mt-1">{{ fileErrors.bpjs
                                        }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('pas_foto', $event)"
                                            accept="image/*" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.pas_foto" class="text-red-500 text-sm mt-1">{{
                                            fileErrors.pas_foto }}</p>
                                    </div>

                                    <div>
                                        <label class="block text-gray-700 font-medium mb-2">
                                            Surat Pernyataan Keabsahan Data *
                                            <span class="text-sm text-gray-500">(Ditandatangani ketua kontingen +
                                                bermaterai)</span>
                                        </label>
                                        <input type="file" @change="handleFileUpload('surat_pernyataan', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.surat_pernyataan" class="text-red-500 text-sm mt-1">{{
                                            fileErrors.surat_pernyataan }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('surat_layak_bertanding', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.surat_layak_bertanding" class="text-red-500 text-sm mt-1">{{
                                            fileErrors.surat_layak_bertanding }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" @change="handleFileUpload('form_prq', $event)"
                                            accept="image/*,.pdf" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                        <p v-if="fileErrors.form_prq" class="text-red-500 text-sm mt-1">{{
                                            fileErrors.form_prq }}</p>
                                    </div>
                                    ...
                                    <template v-if="form.jenis_peserta === 'Mitra'">
                                        ...
                                        <div>
                                            <label class="block text-gray-700 font-medium mb-2">
                                                ...
                                                <span class="text-sm text-gray-500">(Minimal 6 bulan, status
                                                    aktif)</span>
                                            </label>
                                            <input type="file"
                                                ...
                                                accept="image/*,.pdf" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                            <p v-if="fileErrors.surat_keterangan_kerja"
                                                class="text-red-500 text-sm mt-1">{{ fileErrors.surat_keterangan_kerja
                                                }}</p>
                                        </div>
                                        ...
                                        <div>
                                            <label class="block text-gray-700 font-medium mb-2">
                                                Kontrak Kerja *
                                                <span class="text-sm text-gray-500">(Minimal 1 tahun atau PKWT
                                                    sebelumnya jika kurang dari 1 tahun)</span>
                                            </label>
                                            <input type="file" @change="handleFileUpload('kontrak_kerja', $event)"
                                                accept="image/*,.pdf" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                            <p v-if="fileErrors.kontrak_kerja" class="text-red-500 text-sm mt-1">{{
                                                fileErrors.kontrak_kerja }}</p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="file" @change="handleFileUpload('sertifikat_bst', $event)"
                                                accept="image/*,.pdf" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                                            <p v-if="fileErrors.sertifikat_bst" class="text-red-500 text-sm mt-1">{{
                                                fileErrors.sertifikat_bst }}</p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="url" v-model="form.media_sosial" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent"
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" v-model="form.wilayah_kerja" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent"
...
export default {
    ...
    computed: {
        ...
        labelBPJS() {
            return this.form.jenis_peserta === 'Pekerja'
                ? 'Kartu Medika Plaza dan BPJS'
                : 'Rekam Layar Kartu Digital BPJS';
        }
    },
    methods: {
        toggleSidebar() {
