                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                ...
                                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                                    ...
                                    <select v-model="filterJenisPeserta"
                                    ...
                                    <select v-model="filterCabangOlahraga"
                                        class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
                        ...
                        <div v-if="loading" class="bg-white rounded-lg shadow-md p-12">
                            <div class="text-center">
                                <div
                                    class="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-[#D71E28]">
                                </div>
                                <p class="mt-4 text-gray-600">Memuat data peserta...</p>
                            </div>
                        </div>

                        <div v-else-if="participants.length === 0 && !loading"
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-gray-600 mb-6">Belum ada peserta yang mendaftarkan diri untuk kegiatan
                                    ini.</p>
                                <router-link to="/peserta/formulir-pendaftaran"
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr v-for="(participant, index) in filteredParticipants"
                                                :key="participant.id" class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="flex-shrink-0 h-10 w-10">
                                                            <div
                                                                class="h-10 w-10 rounded-full bg-[#D71E28] flex items-center justify-center">
                                ...
                                <div class="p-4 space-y-4">
                                    <div v-for="(participant, index) in filteredParticipants" :key="participant.id"
                                        ...
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center">
                                                <div
                                                    class="flex-shrink-0 h-12 w-12 bg-[#D71E28] rounded-full flex items-center justify-center mr-3">
                                                    <span class="text-white font-medium">
                                                        {{ getInitials(participant.nama_lengkap) }}
                                                    </span>
                                                </div>
                                                <div>
                                                    <h3 class="font-medium text-gray-900">{{ participant.nama_lengkap }}
                                                    </h3>
                        ...
                        <div v-if="filteredParticipants.length > 0"
                            class="bg-white px-4 py-3 mt-6 rounded-lg shadow-md flex items-center justify-between border-t border-gray-200">
                ...
                <div class="mt-3">
                    ...
                    <div v-if="selectedParticipant" class="space-y-4">
                        ...
                        <div v-if="selectedParticipant.media_sosial">
                            ...
                            <a :href="selectedParticipant.media_sosial" target="_blank"
                                class="mt-1 text-sm text-[#D71E28] hover:underline">
