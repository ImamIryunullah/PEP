    ...
    <section class="min-h-screen relative bg-[#F7F7F7] w-full overflow-hidden">
      ...
      <div class="absolute inset-0 z-0 pointer-events-none">
        ...
        <div class="hidden lg:block">
          <h1 class="absolute top-16 xl:top-20 left-12 xl:left-20 text-gray-600 opacity-5 text-7xl xl:text-9xl font-bold">LOG</h1>
          <h1 class="absolute top-40 xl:top-52 left-12 xl:left-20 text-gray-600 opacity-5 text-7xl xl:text-9xl font-bold">IN</h1>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 backdrop-blur-sm bg-opacity-95">
              ...
              <form class="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <div class="flex items-center bg-[#a60000] text-white px-3 sm:px-4 py-3 sm:py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                      <img src="/registrasi/bunga.png" alt="Email Icon" class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" />
                      <input 
                        type="email" 
                ...
                <div>
                  ...
                  <div class="relative">
                    <div class="flex items-center bg-[#a60000] text-white px-3 sm:px-4 py-3 sm:py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                      <img src="/registrasi/bunga.png" alt="Password Icon" class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" />
                      <input 
                        type="password" 
                ...
                <div class="pt-2 sm:pt-4">
                  <button 
                    type="submit"
                    class="w-full bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-bold py-3 sm:py-4 px-6 rounded-full shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-in-out text-sm sm:text-base"
                  >
                ...
                <div class="text-center text-xs sm:text-sm text-gray-600 pt-4">
                  Belum punya akun?
                  <a href="/registrasi" class="text-red-600 hover:text-red-700 hover:underline font-medium ml-1 transition-colors duration-200">
                    Daftar sekarang
                  </a>
                </div>
              </form>
