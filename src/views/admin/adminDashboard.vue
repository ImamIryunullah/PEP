...
export default {
  ...
  data() {
    return {
      ...
      availableCabangOlahraga: [
        'Sepak Bola', 'Basket', 'Voli', 'Badminton', 'Tenis Meja',
        'Futsal', 'Atletik', 'Renang', 'Bulutangkis'
      ]
    };
  },
  ...
  methods: {
    ...
    getProgressPercentage(count) {
      const maxExpected = 50; // Maximum expected participants per sport
