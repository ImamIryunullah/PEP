            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="peserta in paginatedPeserta" :key="peserta.email" 
                      class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div class="flex-shrink-0 h-12 w-12">
                          <img v-if="peserta.foto" 
                               :src="peserta.foto" 
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md">
          ...
          <form @submit.prevent="savePeserta" class="px-6 py-4 space-y-4">
            <div>
              ...
              <input v-model="formData.namaLengkap" 
                     type="text" 
                     required
            ...
            <div>
              ...
              <select v-model="formData.jenisPeserta" 
                      required
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
            ...
            <div>
              ...
              <select v-model="formData.cabangOlahraga" 
                      required
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D71E28] focus:border-transparent">
